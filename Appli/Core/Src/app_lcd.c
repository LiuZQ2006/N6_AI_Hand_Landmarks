...
app_rectangle_t *app_lcd_get_bg_area(void)
{
    return &app_lcd_bg_area;
}

app_rectangle_t *app_lcd_get_fg_area(void)
{
    return &app_lcd_fg_area;
}

uint8_t *app_lcd_get_bg_buffer_by_index(uint8_t index)
{
